...
public class KotikServiceTest {
    ...
    public void testFindAllFriends() {
        ...
        List<KotikDto> friends = kotikService.findFriendsByKotikId(1L);
    ...
    public void testIsFriends() {
        Mockito.when(friendsRepository.findByKotikiId(1L, 3L)).thenReturn(friends1);
        assertTrue(kotikService.isFriends(1L, 3L));
    }
}
